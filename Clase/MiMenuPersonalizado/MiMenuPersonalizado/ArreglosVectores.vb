...
Public Class ArreglosVectores
    ...
    Private Sub cmbSolicitar_MouseHover(sender As Object, e As EventArgs) Handles cmbSolicitar.MouseHover
        Informacion.SetToolTip(cmbSolicitar, "Muestra las Computadoras Ingresadas")
        Informacion.ToolTipTitle = "Computadoras"
        Informacion.ToolTipIcon = ToolTipIcon.Info
    End Sub
    ...
    Private Sub btnLimpiarVenta_MouseHover(sender As Object, e As EventArgs) Handles btnLimpiarVenta.MouseHover
